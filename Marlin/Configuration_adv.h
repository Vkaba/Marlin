 ...
 */
#define CONFIGURATION_ADV_H_VERSION CONFIGURATION_H_VERSION
...
#define HOMING_BUMP_MM      { 0, 0, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
//#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 3.8, 3.8 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
